...
public class BABTMain {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event)
    {
        ...
        if (event.getTab() == BT_TAB.get()) {
            ...
            event.accept(BTItems.LAND_MONOLITH_KEY);
            event.accept(BTItems.OCEAN_MONOLITH_KEY);
            event.accept(BTItems.CORE_MONOLITH_KEY);
            event.accept(BTItems.NETHER_MONOLITH_KEY);
            ...
            event.accept(BTItems.NETHER_RESONANCE_CRYSTAL);
            event.accept(BTItems.END_RESONANCE_CRYSTAL);
            event.accept(BTItems.SKY_RESONANCE_CRYSTAL);
            event.accept(BTItems.CITY_RESONANCE_CRYSTAL);
        }
    }
