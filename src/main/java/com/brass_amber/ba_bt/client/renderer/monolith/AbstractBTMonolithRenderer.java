...
public abstract class AbstractBTMonolithRenderer extends EntityRenderer<BTMonolith> {
	...
	public AbstractBTMonolithRenderer(EntityRendererProvider.Context context, String monolithType, ModelLayerLocation location) {
		super(context);
	...
	private boolean isLandMonolith() {
		return this.monolithType.equals(LandBTMonolithRenderer.LAND_MONOLITH);
	}
}
